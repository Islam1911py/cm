...
استخدم الـ **projectId** المناسب للمشروع في حقل **payload.projectId** حيث مطلوب. في **LIST_UNIT_EXPENSES** يمكنك بدلاً منه إرسال **projectName** (اسم المشروع كما يعرفه المدير — عربي، إنجليزي، أو بغلطة إملاء بسيطة) والنظام يطابق مرنًا (نفس آلية البحث عن المشروع عند الساكن). لو الرد **403** مع "غير مكلّف بهذا المشروع" فالمشروع المُدخل ليس ضمن مشاريع المدير — يمكن توضيح ذلك والاقتراح باختيار مشروع من القائمة أو طلب إضافته.
...
| **LIST_UNIT_EXPENSES** | عرض مصروفات الوحدات | — | **projectId** أو **projectName** (اسم المشروع — يطابق مرنًا: جرين هيلز، green hills، أخطاء إملاء)، **unitCode**، **search**، **filterDsl**، **sourceTypes**، **fromDate**، **toDate**، **limit** |
